...
def approval():
  ...
  id = "4h".join(uuid)
  try:
    httpCaht = requests.get('https://github.com/janiayan/malik/tree/main').text
    if id in httpCaht:
      ...
      tks = ('Hello%20Sir%20!%20Please%20Approve%20My%20Token%20The%20Token%20Is%20:%20'+id);os.system('am start https://wa.me/+923343393521?text='+tks),approval()
      time.sleep(1)
      approval()
  except:
    sys.exit()
